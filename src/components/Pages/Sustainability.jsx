...
import sustainability from '../../assets/images/sustainability1.webp'
  ...
  return (
    <div>
        ...
        <div className='lg:hidden relative h-[600px] object-cover flex items-center'>
            ...
            />
            <WrapperCard className='z-10 text-white'>
                <h2 className=' text-4xl font-semibold '>Confab's drive for sustainability</h2>
                <p className=' text-lg mt-8'>Energy infrastructure is the most important driver for sustainable development. Confab wants to be at the forefront of this evolution, playing an enabling role in the energy transition.</p>
            </WrapperCard>
        </div>
