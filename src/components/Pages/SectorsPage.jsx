      ...
      <div className='pt-32 lg:pt-48 pb-6 text-main'>
        <WrapperCard className='flex flex-col lg:flex-row justify-between'>
          ...
          <div className='lg:w-2/3 p-4 bg-gray-100'>
            {/* Add the image here */}
            <img loading='eager' height={100} width={100} title={currentSectorData.title} src={currentSectorData.image} alt={currentSectorData.title} className='mb-8 w-full h-auto' />
